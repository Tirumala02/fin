  ...
  return (
    <div>
      ...
      <div className='text-2xl text-center pt-8 border-t'>
          <Title text1={'ABOUT'} text2={'XchangeTechs'} />
      </div>
      ...
      <div className=' text-xl py-4'>
          <Title text1={'WHY'} text2={'CHOOSE XchangeTechs'} />
      </div>
