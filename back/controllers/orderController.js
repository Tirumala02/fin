                                ...
                                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: right; border-bottom: 2px solid #ddd; padding: 10px; background-color: #e9e9e9;">Price</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ${order.items
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 10px; text-align: right; font-weight: bold;">₹${order.amount.toFixed(2)}</td>
                                        </tr>
                                    </tbody>
                                </table>
